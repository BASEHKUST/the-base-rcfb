            ...
            <React.Fragment>
                <div style={{width: '100%', position: 'sticky', top: '0px'}}>
                    ...
                    <div className='header-background'>
                        <div><a href="https://ec.hkust.edu.hk" target="_blank" className='header-ec'>Entrepreneurship Center</a></div>
                ...
                <div className='header-menu'>
                    ...
                    <div className='grid-container' style={{paddingBottom: '25px'}}>
                        ...
                        <div className='grid-item grid-item-2'>
                            <a href="https://www.ust.hk/academics/list" target="_blank">ACADEMIC DEPARTMENT A-Z</a>
                        </div>
                        ...
                        <div className='grid-item grid-item-5'>
                            <a href="https://www.ust.hk/map-directions" target="_blank">MAPS & DIRECTIONS</a>
                        </div>
                        <div className='grid-item grid-item-6'>
                            <a href="https://hkustcareers.ust.hk/" target="_blank">CAREERS AT HKUST</a>
                        </div>
                        ...
                        <div className='grid-item grid-item-8'>
                            <a href="https://www.ust.hk/about" target="_blank">ABOUT HKUST</a>
                        </div>
                    </div>
                </div>
            </React.Fragment>
